...
#else
#define ERRMSG(args...) __android_log_print(ANDROID_LOG_ERROR, "RAOP", args)
#define INFMSG(args... ) __android_log_print(ANDROID_LOG_INFO, "RAOP", args)
#define DBGMSG(args...) __android_log_print(ANDROID_LOG_WARN, "RAOP", args)
#endif
